(function (){
    ...
    const groups = [{
        ...
        list: [{
            name: "Praca w IT dla Stażystów i Juniorów (IT Jobs for Intern/Junior)",
            ...
            name: "Staże i praktyki w branży IT programisci ,administratorzy sieci ,graficy",
    ...
    portals.forEach(portal => {
        document.querySelector(".list--portals").appendChild(createLinkElement(portal));
    });
    ...
    groups.forEach(group => {
        ...
        group.list.forEach(listItem => ul.appendChild(createLinkElement(listItem)));
